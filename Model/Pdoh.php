...
class Pdoh{
  ...
  //if callback returns an array, it will be returned. otherwise, its result is ignored.
  //TODO: callback data should always be returned. only when void, method should return $line
